...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-orange-100 to-orange-200 shadow-inner py-4 px-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-700 z-50 font-sans">
      ...
      <div className="flex space-x-5 mt-2 md:mt-0">
        {/* External links should remain <a> */}
        <a
